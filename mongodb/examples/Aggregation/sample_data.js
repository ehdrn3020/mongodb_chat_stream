...
// 결과 출력
print('[OK] db:', db.getName());
print('[OK] users:', db.users.countDocuments(), 'docs');
print('[OK] chat_messages:', db.chat_messages.countDocuments(), 'docs');
print('[OK] sample (latest 3):');
db.chat_messages.find().sort({ts:-1}).limit(3).forEach(doc => printjson(doc));
